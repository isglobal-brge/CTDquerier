...
```
That is, the {r p1}% of the total number of associations of GALA genes with chemicals are shared with the associations of asthma with chemicals. On the other hand, the {r p2}% of the chemicals associated with asthma are shared with the chemicals associated with GALA genes.
...
We observe that the chemicals associated with GALA genes are enriched in ....
