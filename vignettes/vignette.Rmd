...
Now that the information about the genes of interest was download from *CTDbase* we can access to it using the method `extract`, from `psygenet2r` R package. Method extract allows to access to different tables according to the origin of the \texttt{CTDquery} object. For a \texttt{CTDquery} created from genes the accessible tables are:
...
Now that the information about the chemicals of interest was download from *CTDbase* we can access to it using the method `extract`. Method extract allows to access to different tables according to the origin of the \texttt{CTDquery} object. For a \texttt{CTDquery} created from chemicals the accessible tables are:
...
Now that the information about the diseases of interest was download from *CTDbase* we can access to it using the method `extract`. Method extract allows to access to different tables according to the origin of the \texttt{CTDquery} object. For a \texttt{CTDquery} created from diseases the accessible tables are:
